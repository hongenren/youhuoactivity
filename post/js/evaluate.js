  /**上传图片 追加图片 */
    ...
    function sub_task_msg(){
        var img = "";
        var applyCode = $_GET['applyCode'], type = $_GET['type'], url = "html5/v1/station/postEvaluate/volunteerEvaluate";
        ...
        var json = {"applyCode": applyCode,"content":content,"star":parseInt(star),"imgs":img};
        if(type==1){
            url = "html5/v1/station/postEvaluate/adminEvaluate";
            json.adminUserId = user_msg.userId;
