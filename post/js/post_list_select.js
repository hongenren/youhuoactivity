...
function queryPostByDay(pageNumber, pageSize){//日期
    $(".warp_pws_c").show();
    ...
    $('.warp_pws_c').dropload({
        ...
        loadDownFn: function (me) {
            ...
            pageNumber++;
            var dataJson = {"days": getDate(enterTime).split(","), "pageNumber":pageNumber, "pageSize":pageSize};
            if($("#name_input").val()){
            ...
            $.ajax({
                url: base_url + '/html5/v1/station/queryPostByDay',
                type: "post",
                dataType: "json",
                                ...
                                html += '<li>\
                                                <a href="./post_content.html?pkPostCode=' + val.pkPostCode + '">\
                                                    ...
                                                    <div class="hycon2">\
                                                        ...
                                                        <p>\
                                                            <span id="day">' + val.day + '   ' + val.serviceBeginTime + '-' + val.serviceEndTime + '</span>\
                                                        </p>\
                                                    </div>\
                                                    <div class="hycon2">\
...
function queryPostByTargetService(pageNumber, pageSize){
    ...
    $('.warp_pws_c').dropload({
        ...
        loadDownFn: function (me) {
            $(".dropload-down").remove();
            pageNumber++;
            var dataJson = {"pageNumber":pageNumber, "pageSize":pageSize};
            ...
            $.ajax({
                url: base_url + '/html5/v1/station/queryPostByTargetService',//服务对象
                type: "post",
                dataType: "json",
                data: JSON.stringify(dataJson),
                contentType: "application/json;charset=utf-8",
...
function queryPostByAdCode(pageNumber, pageSize){
    ...
    $('.warp_pws_c').dropload({
        ...
        loadDownFn: function (me) {
            $(".dropload-down").remove();
            pageNumber++;
            var dataJson = {"adCode": adCode, "pageNumber": pageNumber, "pageSize": pageSize};
            if ($("#adCode").html()) {
                $("#adCode").html(adName);
            } else {
            ...
            $.ajax({
                url: base_url + '/html5/v1/station/queryPostByAdCode',
                type: "post",
                dataType: "json",
                data: JSON.stringify(dataJson),
                contentType: "application/json;charset=utf-8",
