;(function ($) {
  $.fn.spinner = function (opts) {
    return this.each(function () {
      ...
      if(textField.attr('data-maxlength')==textField.val()){
          increaseButton = $('<button type="button" class="increase" disabled="disabled">+</button>').click(function () { changeValue(1) })
      }
      if(textField.attr('data-time')){
          textField.val(textField.attr('data-time'))
      }
      ...
      function validate(field) {
        ...
        if (value >= textField.attr('data-maxlength')) increaseButton.attr('disabled', 'disabled')
