    ...
    //活动场次
    function get_activity_detail(activityCode, ticket)
    {
        var html ='';
        var data_list = '';
        $.ajax({
            ...
            data:JSON.stringify({"activityCode":activityCode,"ticket":ticket,"pageSize":10000}),
            dataType:'json',
            headers : {'token':token},
            async:false,
            contentType: "application/json;charset=utf-8",
    ...
    //待审核人员
    function get_activity_auditee(sectionCode,typeNum,recruitCode="",taskCode="")
    {
        if(typeNum == 1){
            var url   = base_url + "html5/v1/recruit/selectBySectionRecruit";
            var datas = JSON.stringify({"sectionCode":sectionCode,"recruitCode":recruitCode,"pageNumber":1,"pageSize":20,"state":10});
        }else if(typeNum == 2){
            var url = base_url + "html5/v1/task/selectAppliesBySectionTask";
            var datas = JSON.stringify({"sectionCode":sectionCode,"pageNumber":1,"pageSize":20,"state":10,"taskCode":taskCode});
        }else if(typeNum == 3){
            var url   = base_url + "html5/v1/public/selectAppliesBySection";
            var datas = JSON.stringify({"sectionCode":sectionCode,"pageNumber":1,"pageSize":20,"state":10});
        }else if(typeNum == 4){
            var url   = base_url + "html5/v1/manager/selectAppliesBySection";
            var datas = JSON.stringify({"sectionCode":sectionCode,"pageNumber":1,"pageSize":20,"state":10,"activityCode":$_GET['activityCode']});
        }else if(typeNum == 5){
            var url   = base_url + "html5/v1/mediaGuest/queryAppliesBySection";
            var datas = JSON.stringify({"sectionCode":sectionCode,"pageNumber":1,"pageSize":20,"state":10,"type":50});
        }else if(typeNum == 6){
            var url   = base_url + "html5/v1/mediaGuest/queryAppliesBySection";
            var datas = JSON.stringify({"sectionCode":sectionCode,"pageNumber":1,"pageSize":20,"state":10,"type":60});
        }
        //console.log(url)
        //console.log(datas)
        $.ajax({
    ...
    function search_list(sectionCode,searchVal,typeNum)
    {
        var recruitcode = "";
        var taskcode    = "";
        ...
        if(typeNum == 1){
            ...
            var datas = JSON.stringify({"sectionCode":sectionCode,"recruitcode":recruitcode,"pageNumber":1,"pageSize":20,"state":10,"searchValue":searchVal});
        }else if(typeNum == 2){
            var url = base_url + "html5/v1/task/searchTaskSubmit";
            var datas = JSON.stringify({"sectionCode":sectionCode,"pageNumber":1,"pageSize":20,"searchValue":searchVal,"taskcode":taskcode});
        }else if(typeNum == 3){
            var url   = base_url + "html5/v1/public/searchApplies";
            var datas = JSON.stringify({"sectionCode":sectionCode,"pageNumber":1,"pageSize":20,"state":10,"searchValue":searchVal});
        }else if(typeNum == 4){
            var url   = base_url + "html5/v1/manager/searchApplies";
            var datas = JSON.stringify({"sectionCode":sectionCode,"pageNumber":1,"pageSize":20,"activityCode":$_GET['activityCode'],"searchValue":searchVal});
        }else if(typeNum == 5){
            var url   = base_url + "html5/v1/mediaGuest/searchApply";
            var datas = JSON.stringify({"sectionCode":sectionCode,"pageNumber":1,"pageSize":20,"state":10,"type":50,"searchValue":searchVal});
        }else if(typeNum == 6){
            var url   = base_url + "html5/v1/mediaGuest/searchApply";mediaGuest/queryAppliesBySection
            var datas = JSON.stringify({"sectionCode":sectionCode,"pageNumber":1,"pageSize":20,"state":10,"type":60,"searchValue":searchVal});
        }
        //console.log(url)
        //console.log(datas)
        $.ajax({
    ...
    $(function(){
        ...
        }else if(type==80 || type==70){
            $('.warp_gl_i1').show();
            $('.QRCode').show();//扫一扫
            $('.broadcast').show();//通知广播
            $('.enroll_list').show();//报名表
            $('.task_list').show();//任务管理
            $('.startCan').show();//临时管理员
        }else if(type==90){
            $('.warp_gl_i1').show();
