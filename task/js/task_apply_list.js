...
function queryPostByRecommend(pageNumber, pageSize){
    ...
    $('#content').dropload({
        ...
        loadDownFn: function (me) {
            ...
            pageNumber++;
            if ($("#name_input").val()) {
                enableData.name = $("#name_input").val();
            }
            ...
            $.ajax({
                ...
                type: 'post',
                url: base_url + "/html5/v1/newTask/groupApplyEnable",
                    ...
                    if (data.code == 0) {
                        ...
                        if(data_index.length>0) {
                            $.each(data_index, function (k, val) {
                                ...
                                var user_list = "";
                                var postonclick = 'onclick="jump(\'./task_content_sub.html?pkPostCode='+val.subCode+'&type='+val.mainCode+'&groupType=1\')"';
                                var user_list = "";
                                if(type==1){
