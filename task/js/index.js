        ...
        layer.open({
            ...
            ,yes: function(index){
                ...
                $.ajax({
                    ...
                    type: 'post',
                    url: base_url + "/html5/v1/newTask/add",
...
//    添加子任务
    ...
    $(".task_add_subBtn").click(function(){
        ...
        var li=' <div class="task_sub_list">\n' +
            ...
            '                    </li>\n' +
            '                    <li>\n' +
            '                        <a href="javascript:void(0)" style="background: none;height:auto;">\n' +
            '                            <input id="contactMobile" oninput="checkLength_98(this, 11)" placeholder="选填，请填写手机号"  type="text"/>\n' +
            ...
            '                    </li>\n' +
            '                    <li>\n' +
            '                        <a href="javascript:void(0)" style="background: none;height:auto;padding-top:50px;">\n' +
            '                            <input class=\'serviceEndTime demo_time'+len+'\' id="serviceEndTime'+len+'" type="text" readonly="true"\n' +
            '                                   name="applyEndTime'+len+'" placeholder="选择结束" value="" style="width:45%;"/>\n' +
            '                            <span style="margin:0px;float: right;width: 10%;text-align: center;">至</span>\n' +
            '                            <input class=\'serviceBeginTime demo_time'+len+'\' id="serviceBeginTime'+len+'" type="text" readonly="true"\n' +
            '                                   name="applyBeginTime'+len+'" placeholder="选择开始" value="" style="width:45%;"/>'+
            '                            <b>子任务时间</b>\n' +
            '                        </a>\n' +
            '                    </li>\n' +
            '                    <li>\n' +
            ...
            // '                            <input type="text" id="suggestId'+len+'" placeholder="请输入地点或名称进行查询" class="mapTest" disabled="disabled"/>\n' +
            '                            <textarea rows="1" disabled="disabled" oninput="autoHeightArea(this)" style="max-width:70%;float:right;" id="suggestId'+len+'" placeholder="请输入地点或名称进行查询" class="map mapTest" ></textarea>'+
        ...
        console.log('.demo_time'+len)
        // for(var j=0;j<len;j++){
        //     $('.demo_time'+parseInt(j+1)).mobiscroll().datetime({
        //         theme: theme,
        //         mode: mode,
        //         display: display,
        //         lang: lang,
        ...
        //         showNow: true
        //     });
        //     console.log('.demo_time'+parseInt(j+1))
        // }
