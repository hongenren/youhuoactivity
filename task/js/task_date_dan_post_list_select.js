...
var date = function ($) {
    ...
    $.fn.hotelDate = function (options) {
        ...
        function initTemplate() {
            ...
            // 主容器模板
            var dateTemplate = '\n        <div class =\'date container c-gray\' style="top:auto;left: auto;position:static;">\n          <h4 class="tac" style="float: left;color: #CCCCCC;font-size: 14px;margin-left: 10px;"></h4>\n          <div class=\'close-btn\' style=\'top:7px;left:auto;right: 10px;z-index:121701;\'>\u786E\u5B9A</div>\n        </div>      \n      ';
            ...
            $('.action').each(function (index, item) {
                ...
                for (var i = 0; i < days + nowweek; i++) {
                    ...
                    }else if (input_enter.indexOf(dateArr[index].getFullYear() + '-' + (dateArr[index].getMonth() + 1) + '-' + (i - nowweek + 1)+",")!= -1) {
                        // 默认入住时间
                        listIndex++;
            ...
            $('.close-btn').on('click', function () {
                ...
                //$('.condition').height($('#0').height()+10+"px");
                closeData();
            });
